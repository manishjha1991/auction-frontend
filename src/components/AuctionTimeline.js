...
const SCHEDULE = [
  ...
  { key: 'sellAfterExit', label: 'Sell after 2nd-highest exit', hour: 0, minute: 45, note: '12:44 freeze solo lots; 12:45 sell if other bid already gone (no exit); from 12:50 every 5 min exit / sell if exited ≥ 2 min' },
