...
const PlayerList = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://backend.cpl.in.net/players') // Adjust this URL as per your backend route
      .then((response) => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://backend.cpl.in.net/players/${editingPlayer._id}`, form, {
        headers: {
    ...
    <div className="player-list-container">
      ...
      <div className="player-list">
        {currentPlayers.map((player) => (
          ...
          >
            <img src={`https://backend.cpl.in.net/${player.image}`} alt={player.name} className="player-image" />
